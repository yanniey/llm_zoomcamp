...
1. Small-to-big chunk retrieval - use small chunks for indexing but retrieve surrounding context (e.g. parent-child document retrieval, sentence-window retrieval) for the LLM
...
4. User query rewriting - use an LLM to reformulate the user's
   question into a more structured query
