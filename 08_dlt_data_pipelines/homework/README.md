...
link: https://github.com/DataTalksClub/llm-zoomcamp/blob/main/cohorts/2026/workshops/dlt/homework.md
...
then serve dlt locally:

```bash
uv run dlthub local show
```
<img src="homework_q2_dlt_local_dashboard.png" width=600>
